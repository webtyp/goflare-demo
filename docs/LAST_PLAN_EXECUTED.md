...
# Plan — `webtyp.com/goflare-demo`: a list stops claiming it has columns
...
**Files:** `modules/contact/model_orm.go` (2 list types).
...
| Stage | Files | Action |
|---|---|---|
| 1 | `modules/contact/model_orm.go` | regenerate with `ormc`; 2 stub pairs disappear |
